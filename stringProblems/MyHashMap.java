...
public class MyHashMap<K, V> {
	/*
	 * K is String, V is Integer for a simpler version Supported operations: size()
	 * isEmpty() clear() put(K key, V value get(K key) containsKey(K key)
	...
	private int hash(K key) {
		...
		// 2.3. hashCode()
		/*
		 * int code = key.hashCode(); return code >= 0 ? code : -code; int range =
		 * [-2^31, 2^31 - 1]; -Integer.MIN_VALUE = Integer.MIN_VALUE; -> overflow
		 */
		// Guarantee non-negative
		// Reason: java's % return remainder rather than modulus. The remainder can be
		// negative
		// -1 to 3 remainder: -1
		// -1 to 3 modulo: 2
